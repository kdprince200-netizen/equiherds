...
// Schema for special facilities services
...
const servicePriceDetailsSchema = new mongoose.Schema({
  ...
  specialFacilities: {
    indoorArena: { type: Boolean, default: false },
    indoorArenaPrice: { type: Number, default: 0 },
    walker: { type: Boolean, default: false },
    walkerPrice: { type: Number, default: 0 },
    treadmill: { type: Boolean, default: false },
    treadmillPrice: { type: Number, default: 0 },
    spa: { type: Boolean, default: false },
    spaPrice: { type: Number, default: 0 },
    solarium: { type: Boolean, default: false },
    solariumPrice: { type: Number, default: 0 },
    lungingArena: { type: Boolean, default: false },
    lungingArenaPrice: { type: Number, default: 0 }
  }
}, { _id: false, strict: false }); // Add strict: false to allow additional fields
