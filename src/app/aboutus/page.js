...
export default function AboutPage() {
  return (
    <div className="font-sans">
      <TopSection title="About us" bgImage="/slider/4.jpg" />
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              We exist to honor the bond between horse and human — by bringing together those who care, teach, heal, and protect them. Equiherds connects the equestrian world with trust, elegance, and purpose.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Bob Slingerland</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Khawaja Zubair Ahmed</h4>
              <p className="text-brand font-medium mb-2">Founding Partner</p>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Claire Slingerland </h4>
              <p className="text-brand font-medium mb-2">Head Equestrian Relations</p>
              <p className="text-gray-600 text-sm">
                Expert trainer with years of experience in horse training and equestrian education
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-gradient-to-r from-brand to-green-600 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/services?type=trainer"
              className="bg-primary text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Browse Services
            </a>
            <a
