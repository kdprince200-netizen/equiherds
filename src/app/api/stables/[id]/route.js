...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const { 
      ...
      status, sponsoredType, noofRatingCustomers, shortTermStay, longTermStay, stallionsAccepted, 
    ...
    if (specialFacilities !== undefined) update.specialFacilities = specialFacilities;
