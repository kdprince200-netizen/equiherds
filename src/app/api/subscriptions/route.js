...
export async function POST(req) {
  ...
  try {
    ...
    if (body.offermonth !== undefined && (typeof body.offermonth !== "number" || body.offermonth < 0)) {
      return NextResponse.json(
    ...
    if (body.discountoffermonth !== undefined && (typeof body.discountoffermonth !== "number" || body.discountoffermonth < 0 || body.discountoffermonth > 100)) {
      return NextResponse.json(
