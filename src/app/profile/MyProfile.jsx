    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {/* Address Fields */}
          <div className="p-4 rounded border border-[color:var(--primary)] bg-white">
            <label className="block mb-1 text-sm opacity-80">Country</label>
            <input
              type="text"
              value={country}
          ...
          <div className="p-4 rounded border border-[color:var(--primary)] bg-white">
            <label className="block mb-1 text-sm opacity-80">Zip Code</label>
            <input
              type="text"
              value={zipcode}
          ...
          <div className="p-4 rounded border border-[color:var(--primary)] bg-white sm:col-span-2">
            <label className="block mb-1 text-sm opacity-80">Address Line 1</label>
            <input
              type="text"
              value={address1}
          ...
          <div className="p-4 rounded border border-[color:var(--primary)] bg-white sm:col-span-2">
            <label className="block mb-1 text-sm opacity-80">Address Line 2</label>
            <input
              type="text"
              value={address2}
          ...
          {accountType?.toLowerCase() !== "buyer" && (
            <>
              ...
              <div className="p-4 rounded border border-[color:var(--primary)] bg-white">
                <label className="block mb-1 text-sm opacity-80">VAT Number</label>
                <input
                  type="text"
                  value={vatNo}
              ...
              <div className="p-4 rounded border border-[color:var(--primary)] bg-white">
                <label className="block mb-1 text-sm opacity-80">Stripe Account ID</label>
                <input
                  type="text"
