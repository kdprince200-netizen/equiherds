  ...
  const filtered = useMemo(() => {
    ...
    const base = items
      ...
      return matchesSearch && matchesRating && matchesPrice && matchesDay && 
             matchesDisciplines && matchesTrainingType && matchesCompetitionCoaching && matchesNearMe;
    });
    ...
    return base;
  }, [items, search, minRating, priceMin, priceMax, selectedDay, selectedDisciplines, trainingType, competitionCoaching, useNearMe, radiusKm, userLocation]);
                    ...
                    <div className="flex flex-col gap-3">
                      {canUserBook() ? (
                        ...
                        <button
                          ...
                          title={userData ? "Only buyers can book training sessions" : "Please login to book"}
                        >
