            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 w-full h-full">
              <div className="md:pr-6">
                ...
                <div className="mt-6 flex gap-3">
                  <a href="/services?type=trainer" className="rounded bg-primary text-white px-4 py-2 text-[14px] sm:text-[15px] hover:opacity-90">Get Started</a>
                  <a href="/contactus" className="rounded border border-white/30 text-white px-4 py-2 text-[14px] sm:text-[15px] hover:bg-white/10">Contact Us</a>
                </div>
              </div>
