      ...
      try {
        ...
        const allStables = data.map((s) => {
          ...
          return {
            ...
            sponsoredType: s?.sponsoredType || "",
            isSponsored: s?.sponsoredType === "sponsored",
          };
        });
    ...
    <section className="py-8 px-4 sm:px-8 lg:px-16 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="items-center justify-items-center p-8 text-center">
          <h2 className="text-2xl font-semibold primary mb-4"> For Your Horse</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {!loading && !error && tiles.map((tile) => (
            <div key={tile.id} className="text-center px-4 relative">
              {/* Sponsored Badge */}
              {tile.isSponsored && (
